...
/**
 * [LockTaskUseCase] is a Use Case responsible for locking the currently active task.
 *
...
class LockTaskUseCase @Inject constructor(private val tasksRepository: TasksRepository) {
