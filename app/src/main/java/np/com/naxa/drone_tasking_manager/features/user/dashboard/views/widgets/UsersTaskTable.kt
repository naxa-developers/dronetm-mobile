    ...
    Surface(
        ...
        Column {
            ...
            Row(
                ...
                TableHeaderCell("ID", 0.1f)
                TableHeaderCell("Project Name", 0.3f)
                TableHeaderCell("Total task area in km²", 0.2f)
                TableHeaderCell("Created Date", 0.2f)
                TableHeaderCell("Status", 0.2f)
            }

            // Table Content
            LazyColumn {
                items(tasks.size) { index ->
                    TaskRow(tasks.get(index), index)
                }
            }
        }
    }
