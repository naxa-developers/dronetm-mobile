...
//
//                    Activity.RESULT_OK -> {
//                        Log.d("TAG", "googleLoginActivityResult: ${intent?.data}")
//                        GoogleSignIn.getSignedInAccountFromIntent(intent)
//                    }
//            else -> {
//                Log.d("TAG", "googleLoginActivityResult: ${intent?.data}")
//                Log.d("TAG", "googleLoginActivityResult: $resultCode")
//
//                null
//            }
//        }

        Log.d("AuthResultContract", "googleLoginActivityResult Result Code: $resultCode")
        Log.d("AuthResultContract", "googleLoginActivityResult Intent data: ${intent?.data}")
        Log.d("AuthResultContract", "googleLoginActivityResult Intent extras: ${intent?.extras.toString()}")
